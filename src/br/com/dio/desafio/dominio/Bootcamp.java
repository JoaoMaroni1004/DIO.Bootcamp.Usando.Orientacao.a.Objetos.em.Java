...
public class Bootcamp {
    ...
    @Override
    public boolean equals(Object objetoBoot) {
        if (this == objetoBoot) return true;
        if (objetoBoot == null || getClass() != objetoBoot.getClass()) return false;
        Bootcamp bootcamp = (Bootcamp) objetoBoot;
